...
const api_output_path = "res://lib/twitcher/generated/twitch_rest_api.gd"
...
func generate_rest_api() -> void:
	...
	print("REST API regenerated you can find it under: res://lib/twitcher/generated/")
...
func _generate_repositories():
	...
	var template_method = template.read_template_file("res://lib/twitcher/editor/template_method.txt");
	var template_parameter_optional = template.read_template_file("res://lib/twitcher/editor/template_method_parameters_optional.txt");
	var template_body_optional = template.read_template_file("res://lib/twitcher/editor/template_method_body_optional.txt");
	#var gdscript_code := ""
	...
	template.process_template("res://lib/twitcher/editor/template_api.txt", {"methods": data}, api_output_path)
...
func _parse_parameters(method_spec: Dictionary) -> Dictionary:
	...
	if append_broadcaster:
		parameters_code += "broadcaster_id: String = RS.settings.broadcaster_id, "
		all_parameters_code += "broadcaster_id: String = RS.settings.broadcaster_id, "
		optional_body_parameters_code += "broadcaster_id: String = RS.settings.broadcaster_id, "
...
func _generate_components():
	...
	for schema_name in schemas:
		...
		template.process_template("res://lib/twitcher/editor/template_component.txt",
				data, "res://lib/twitcher/generated/" + file_name);

func _calculate_template(_schema_name: String, schema: Dictionary, result_classes: Array, result_properties: Array[Dictionary]):
...
func _get_sub_classes(parent_property_name:String, properties: Dictionary, result_classes: Array, class_description: String = "") -> Dictionary:
	...
	var template_component_class = template.read_template_file(
			"res://lib/twitcher/editor/template_component_class.txt");
