...
func _init(twitch_auth: TwitchAuth) -> void:
	client = BufferedHTTPClient.new(RS.settings.api_host);
	auth = twitch_auth;
...
func request(path: String, method: int, body: Variant = "", content_type: String = "", error_count: int = 0) -> BufferedHTTPClient.ResponseData:
	var header : Dictionary = {
		...
		"Client-ID": RS.settings.client_id
	};
	if content_type != "":
	...
	if response.client.get_response_code() == 401 || response.client.get_response_code() == 403:
		...
		if error_count + 1 < MAX_AUTH_ERRORS:
			...
			var empty_response = client.empty_response(_request);
...
func get_ad_schedule(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetAdScheduleResponse:
...
func snooze_next_ad(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchSnoozeNextAdResponse:
...
func get_cheermotes(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCheermotesResponse:
...
func get_channel_information(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelInformationResponse:
...
func modify_channel_information(body: TwitchModifyChannelInformationBody, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/channels?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
...
##
## https://dev.twitch.tv/docs/api/reference#modify-channel-information
func modify_channel_information_bopt(body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/channels?"
...
func get_channel_editors(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelEditorsResponse:
...
func get_followed_channels(user_id: String, first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetFollowedChannelsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-followed-channels
func get_followed_channels_opt(user_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetFollowedChannelsResponse:
	var path = "/helix/channels/followed?"
...
func get_channel_followers(user_id: String, first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelFollowersResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-channel-followers
func get_channel_followers_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelFollowersResponse:
	var path = "/helix/channels/followers?"
...
func create_custom_rewards(body: TwitchCreateCustomRewardsBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchCreateCustomRewardsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#create-custom-rewards
func create_custom_rewards_bopt(body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchCreateCustomRewardsResponse:
	var path = "/helix/channel_points/custom_rewards?"
...
func delete_custom_reward(id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/channel_points/custom_rewards?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "id=" + str(id) + "&"
...
func get_custom_reward(id: Array[String], only_manageable_rewards: bool, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCustomRewardResponse:
	var path = "/helix/channel_points/custom_rewards?"
	for param in id:
		path += "id=" + str(param) + "&"
...
##
## https://dev.twitch.tv/docs/api/reference#get-custom-reward
func get_custom_reward_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCustomRewardResponse:
	var path = "/helix/channel_points/custom_rewards?"
...
func update_custom_reward(id: String, body: TwitchUpdateCustomRewardBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateCustomRewardResponse:
	var path = "/helix/channel_points/custom_rewards?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "id=" + str(id) + "&"
	var response = await request(path, HTTPClient.METHOD_PATCH, body, "application/json");
...
##
## https://dev.twitch.tv/docs/api/reference#update-custom-reward
func update_custom_reward_bopt(id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateCustomRewardResponse:
	var path = "/helix/channel_points/custom_rewards?"
...
func get_custom_reward_redemption(reward_id: String, status: String, id: Array[String], sort: String, after: String, first: int, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCustomRewardRedemptionResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-custom-reward-redemption
func get_custom_reward_redemption_opt(reward_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCustomRewardRedemptionResponse:
	var path = "/helix/channel_points/custom_rewards/redemptions?"
...
func update_redemption_status(id: Array[String], reward_id: String, body: TwitchUpdateRedemptionStatusBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateRedemptionStatusResponse:
	var path = "/helix/channel_points/custom_rewards/redemptions?"
	for param in id:
		path += "id=" + str(param) + "&"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
...
##
## https://dev.twitch.tv/docs/api/reference#update-redemption-status
func update_redemption_status_bopt(id: Array[String], reward_id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateRedemptionStatusResponse:
	var path = "/helix/channel_points/custom_rewards/redemptions?"
...
func get_charity_campaign(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCharityCampaignResponse:
...
func get_charity_campaign_donations(first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCharityCampaignDonationsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-charity-campaign-donations
func get_charity_campaign_donations_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCharityCampaignDonationsResponse:
	var path = "/helix/charity/donations?"
...
func get_chatters(moderator_id: String, first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChattersResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-chatters
func get_chatters_opt(moderator_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChattersResponse:
	var path = "/helix/chat/chatters?"
...
func get_channel_emotes(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelEmotesResponse:
...
func get_channel_chat_badges(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelChatBadgesResponse:
...
func get_chat_settings(moderator_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChatSettingsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-chat-settings
func get_chat_settings_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChatSettingsResponse:
	var path = "/helix/chat/settings?"
...
func update_chat_settings(moderator_id: String, body: TwitchUpdateChatSettingsBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateChatSettingsResponse:
	var path = "/helix/chat/settings?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "moderator_id=" + str(moderator_id) + "&"
	var response = await request(path, HTTPClient.METHOD_PATCH, body, "application/json");
...
##
## https://dev.twitch.tv/docs/api/reference#update-chat-settings
func update_chat_settings_bopt(moderator_id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateChatSettingsResponse:
	var path = "/helix/chat/settings?"
...
func get_shared_chat_session(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetSharedChatSessionResponse:
...
func get_user_emotes(user_id: String, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetUserEmotesResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-user-emotes
func get_user_emotes_opt(user_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetUserEmotesResponse:
	var path = "/helix/chat/emotes/user?"
...
func send_chat_announcement(moderator_id: String, body: TwitchSendChatAnnouncementBody, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
##
## https://dev.twitch.tv/docs/api/reference#send-chat-announcement
func send_chat_announcement_bopt(moderator_id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/chat/announcements?"
...
func create_clip(has_delay: bool, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
##
## https://dev.twitch.tv/docs/api/reference#create-clip
func create_clip_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/clips?"
...
func get_clips(game_id: String, id: Array[String], started_at: Variant, ended_at: Variant, first: int, before: String, after: String, is_featured: bool, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetClipsResponse:
	var path = "/helix/clips?"
	path += "started_at=" + get_rfc_3339_date_format(started_at) + "&"
	path += "ended_at=" + get_rfc_3339_date_format(ended_at) + "&"
	for param in id:
...
##
## https://dev.twitch.tv/docs/api/reference#get-clips
func get_clips_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetClipsResponse:
	var path = "/helix/clips?"
...
func get_extension_configuration_segment(extension_id: String, segment: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetExtensionConfigurationSegmentResponse:
...
func set_extension_required_configuration(body: TwitchSetExtensionRequiredConfigurationBody, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
##
## https://dev.twitch.tv/docs/api/reference#set-extension-required-configuration
func set_extension_required_configuration_bopt(body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/extensions/required_configuration?"
...
func send_extension_chat_message(body: TwitchSendExtensionChatMessageBody, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
##
## https://dev.twitch.tv/docs/api/reference#send-extension-chat-message
func send_extension_chat_message_bopt(body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/extensions/chat?"
...
func get_creator_goals(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetCreatorGoalsResponse:
...
func get_channel_guest_star_settings(moderator_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelGuestStarSettingsResponse:
...
func update_channel_guest_star_settings(body: TwitchUpdateChannelGuestStarSettingsBody, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/channel_settings?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	var response = await request(path, HTTPClient.METHOD_PUT, body, "application/json");
	return response;
...
##
## https://dev.twitch.tv/docs/api/reference#update-channel-guest-star-settings
func update_channel_guest_star_settings_bopt(body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/channel_settings?"
...
func get_guest_star_session(moderator_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetGuestStarSessionResponse:
...
func create_guest_star_session(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchCreateGuestStarSessionResponse:
	var path = "/helix/guest_star/session?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	var response = await request(path, HTTPClient.METHOD_POST, "", "application/x-www-form-urlencoded");
	var result = JSON.parse_string(response.response_data.get_string_from_utf8());
...
func end_guest_star_session(session_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/session?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
...
func get_guest_star_invites(moderator_id: String, session_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetGuestStarInvitesResponse:
...
func send_guest_star_invite(moderator_id: String, session_id: String, guest_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/invites?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "moderator_id=" + str(moderator_id) + "&"
	path += "session_id=" + str(session_id) + "&"
...
func delete_guest_star_invite(moderator_id: String, session_id: String, guest_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/invites?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "moderator_id=" + str(moderator_id) + "&"
	path += "session_id=" + str(session_id) + "&"
...
func assign_guest_star_slot(moderator_id: String, session_id: String, guest_id: String, slot_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
func update_guest_star_slot(moderator_id: String, session_id: String, source_slot_id: String, destination_slot_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/slot?"
...
##
## https://dev.twitch.tv/docs/api/reference#update-guest-star-slot
func update_guest_star_slot_opt(moderator_id: String, session_id: String, source_slot_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/slot?"
...
func delete_guest_star_slot(moderator_id: String, session_id: String, guest_id: String, slot_id: String, should_reinvite_guest: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/slot?"
...
##
## https://dev.twitch.tv/docs/api/reference#delete-guest-star-slot
func delete_guest_star_slot_opt(moderator_id: String, session_id: String, guest_id: String, slot_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/slot?"
...
func update_guest_star_slot_settings(moderator_id: String, session_id: String, slot_id: String, is_audio_enabled: bool, is_video_enabled: bool, is_live: bool, volume: int, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
##
## https://dev.twitch.tv/docs/api/reference#update-guest-star-slot-settings
func update_guest_star_slot_settings_opt(moderator_id: String, session_id: String, slot_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/slot_settings?"
...
func get_hype_train_events(first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetHypeTrainEventsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-hype-train-events
func get_hype_train_events_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetHypeTrainEventsResponse:
	var path = "/helix/hypetrain/events?"
...
func check_automod_status(body: TwitchCheckAutoModStatusBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchCheckAutoModStatusResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#check-automod-status
func check_automod_status_bopt(body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchCheckAutoModStatusResponse:
	var path = "/helix/moderation/enforcements/status?"
...
func get_automod_settings(moderator_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetAutoModSettingsResponse:
...
func update_automod_settings(moderator_id: String, body: TwitchUpdateAutoModSettingsBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateAutoModSettingsResponse:
	var path = "/helix/moderation/automod/settings?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "moderator_id=" + str(moderator_id) + "&"
	var response = await request(path, HTTPClient.METHOD_PUT, body, "application/json");
...
##
## https://dev.twitch.tv/docs/api/reference#update-automod-settings
func update_automod_settings_bopt(moderator_id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateAutoModSettingsResponse:
	var path = "/helix/moderation/automod/settings?"
...
func get_banned_users(user_id: Array[String], first: int, after: String, before: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetBannedUsersResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-banned-users
func get_banned_users_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetBannedUsersResponse:
	var path = "/helix/moderation/banned?"
...
func ban_user(moderator_id: String, body: TwitchBanUserBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchBanUserResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#ban-user
func ban_user_bopt(moderator_id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchBanUserResponse:
	var path = "/helix/moderation/bans?"
...
func unban_user(moderator_id: String, user_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/moderation/bans?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "moderator_id=" + str(moderator_id) + "&"
	path += "user_id=" + str(user_id) + "&"
...
func get_unban_requests(moderator_id: String, status: String, user_id: String, after: String, first: int, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetUnbanRequestsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-unban-requests
func get_unban_requests_opt(moderator_id: String, status: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetUnbanRequestsResponse:
	var path = "/helix/moderation/unban_requests?"
...
func resolve_unban_requests(moderator_id: String, unban_request_id: String, status: String, resolution_text: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchResolveUnbanRequestsResponse:
	var path = "/helix/moderation/unban_requests?"
...
##
## https://dev.twitch.tv/docs/api/reference#resolve-unban-requests
func resolve_unban_requests_opt(moderator_id: String, unban_request_id: String, status: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchResolveUnbanRequestsResponse:
	var path = "/helix/moderation/unban_requests?"
...
func get_blocked_terms(moderator_id: String, first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetBlockedTermsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-blocked-terms
func get_blocked_terms_opt(moderator_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetBlockedTermsResponse:
	var path = "/helix/moderation/blocked_terms?"
...
func add_blocked_term(moderator_id: String, body: TwitchAddBlockedTermBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchAddBlockedTermResponse:
	var path = "/helix/moderation/blocked_terms?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "moderator_id=" + str(moderator_id) + "&"
	var response = await request(path, HTTPClient.METHOD_POST, body, "application/json");
...
##
## https://dev.twitch.tv/docs/api/reference#add-blocked-term
func add_blocked_term_bopt(moderator_id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchAddBlockedTermResponse:
	var path = "/helix/moderation/blocked_terms?"
...
func remove_blocked_term(moderator_id: String, id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/moderation/blocked_terms?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "moderator_id=" + str(moderator_id) + "&"
	path += "id=" + str(id) + "&"
...
func delete_chat_messages(moderator_id: String, message_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
##
## https://dev.twitch.tv/docs/api/reference#delete-chat-messages
func delete_chat_messages_opt(moderator_id: String, optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/moderation/chat?"
...
func get_moderators(user_id: Array[String], first: String, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetModeratorsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-moderators
func get_moderators_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetModeratorsResponse:
	var path = "/helix/moderation/moderators?"
...
func add_channel_moderator(user_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/moderation/moderators?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "user_id=" + str(user_id) + "&"
	var response = await request(path, HTTPClient.METHOD_POST, "", "application/x-www-form-urlencoded");
...
func remove_channel_moderator(user_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/moderation/moderators?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "user_id=" + str(user_id) + "&"
	var response = await request(path, HTTPClient.METHOD_DELETE, "", "");
...
func get_vips(user_id: Array[String], first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetVIPsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-vips
func get_vips_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetVIPsResponse:
	var path = "/helix/channels/vips?"
...
func add_channel_vip(user_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/channels/vips?"
	path += "user_id=" + str(user_id) + "&"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	var response = await request(path, HTTPClient.METHOD_POST, "", "application/x-www-form-urlencoded");
...
func remove_channel_vip(user_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/channels/vips?"
	path += "user_id=" + str(user_id) + "&"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	var response = await request(path, HTTPClient.METHOD_DELETE, "", "");
...
func update_shield_mode_status(moderator_id: String, body: TwitchUpdateShieldModeStatusBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateShieldModeStatusResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#update-shield-mode-status
func update_shield_mode_status_bopt(moderator_id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateShieldModeStatusResponse:
	var path = "/helix/moderation/shield_mode?"
...
func get_shield_mode_status(moderator_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetShieldModeStatusResponse:
	var path = "/helix/moderation/shield_mode?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "moderator_id=" + str(moderator_id) + "&"
	var response = await request(path, HTTPClient.METHOD_GET, "", "");
...
func warn_chat_user(moderator_id: String, body: TwitchWarnChatUserBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchWarnChatUserResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#warn-chat-user
func warn_chat_user_bopt(moderator_id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchWarnChatUserResponse:
	var path = "/helix/moderation/warnings?"
...
func get_polls(id: Array[String], first: String, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetPollsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-polls
func get_polls_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetPollsResponse:
	var path = "/helix/polls?"
...
func get_predictions(id: Array[String], first: String, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetPredictionsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-predictions
func get_predictions_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetPredictionsResponse:
	var path = "/helix/predictions?"
...
func cancel_a_raid(broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/raids?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	var response = await request(path, HTTPClient.METHOD_DELETE, "", "");
	return response;
...
func get_channel_stream_schedule(id: Array[String], start_time: Variant, utc_offset: String, first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelStreamScheduleResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-channel-stream-schedule
func get_channel_stream_schedule_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelStreamScheduleResponse:
	var path = "/helix/schedule?"
...
func get_channel_icalendar(broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
func update_channel_stream_schedule(is_vacation_enabled: bool, vacation_start_time: Variant, vacation_end_time: Variant, timezone: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
##
## https://dev.twitch.tv/docs/api/reference#update-channel-stream-schedule
func update_channel_stream_schedule_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/schedule/settings?"
...
func create_channel_stream_schedule_segment(body: TwitchCreateChannelStreamScheduleSegmentBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchCreateChannelStreamScheduleSegmentResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#create-channel-stream-schedule-segment
func create_channel_stream_schedule_segment_bopt(body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchCreateChannelStreamScheduleSegmentResponse:
	var path = "/helix/schedule/segment?"
...
func update_channel_stream_schedule_segment(id: String, body: TwitchUpdateChannelStreamScheduleSegmentBody, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateChannelStreamScheduleSegmentResponse:
	var path = "/helix/schedule/segment?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "id=" + str(id) + "&"
	var response = await request(path, HTTPClient.METHOD_PATCH, body, "application/json");
...
##
## https://dev.twitch.tv/docs/api/reference#update-channel-stream-schedule-segment
func update_channel_stream_schedule_segment_bopt(id: String, body: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchUpdateChannelStreamScheduleSegmentResponse:
	var path = "/helix/schedule/segment?"
...
func delete_channel_stream_schedule_segment(id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/schedule/segment?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
	path += "id=" + str(id) + "&"
	var response = await request(path, HTTPClient.METHOD_DELETE, "", "");
...
func get_stream_key(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetStreamKeyResponse:
...
func get_broadcaster_subscriptions(user_id: Array[String], first: String, after: String, before: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetBroadcasterSubscriptionsResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-broadcaster-subscriptions
func get_broadcaster_subscriptions_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetBroadcasterSubscriptionsResponse:
	var path = "/helix/subscriptions?"
...
func check_user_subscription(user_id: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchCheckUserSubscriptionResponse:
...
func get_stream_tags(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetStreamTagsResponse:
...
func get_channel_teams(broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetChannelTeamsResponse:
...
func get_user_block_list(first: int, after: String, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetUserBlockListResponse:
...
##
## https://dev.twitch.tv/docs/api/reference#get-user-block-list
func get_user_block_list_opt(optional: Dictionary, broadcaster_id: String = RS.settings.broadcaster_id) -> TwitchGetUserBlockListResponse:
	var path = "/helix/users/blocks?"
