...
class_name TwitchGetCharityCampaignDonations
	


## 
## #/components/schemas/GetCharityCampaignDonationsResponse
class Response extends TwitchData:
	...
	@export var data: Array[TwitchCharityCampaignDonation]:
		set(val): 
			data = val
			track_data(&"data", val)
	...
	static func create(_data: Array[TwitchCharityCampaignDonation]) -> Response:
...
## An object that contains the information used to page through the list of results. The object is empty if there are no more pages left to page through. [Read More](https://dev.twitch.tv/docs/api/guide#pagination)
## #/components/schemas/GetCharityCampaignDonationsResponse/Pagination
...
## All optional parameters for TwitchAPI.get_charity_campaign_donations
## #/components/schemas/GetCharityCampaignDonationsOpt
