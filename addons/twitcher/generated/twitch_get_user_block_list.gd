...
class_name TwitchGetUserBlockList
...
class Response extends TwitchData:
	...
	@export var data: Array[TwitchUserBlockList]:
		set(val): 
			data = val
			track_data(&"data", val)
	...
	static func create(_data: Array[TwitchUserBlockList]) -> Response:
...
## Contains the information used to page through the list of results. The object is empty if there are no more pages left to page through.[Read More](https://dev.twitch.tv/docs/api/guide#pagination)
## #/components/schemas/GetUserBlockListResponse/Pagination
...
## All optional parameters for TwitchAPI.get_user_block_list
## #/components/schemas/GetUserBlockListOpt
